...
#define I2C_INFORMATION_S_
     ...
     */
        ...
        /**
     * @brief Sets the sleep freq of the MPU, takes a digit from 1 - 4. Use chart on datasheet.
     * 
     * @param mpu6050_t* self: Reference to itself 
     * @param uint8_t state: State to put the device in
     */
     ...
     */
     ...
     /**
     * @brief Enables or disables interrupt flags for data ready.
     * 
     * @param mpu6050_t* self: Reference to itself 
     * @param uint8_t state: 1 to enable or 0 to disable 
     */
    ...
    /**
     * @brief Sets the logic level for the interrupt.
     * 
     * @param mpu6050_t* self: Reference to itself 
     * @param uint8_t state: 1 to enable or 0 to disable 
     */
