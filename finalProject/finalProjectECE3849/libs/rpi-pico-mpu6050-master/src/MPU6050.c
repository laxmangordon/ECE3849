...
uint8_t mpu6050_begin(struct mpu6050 *self)
{
    ...
    mpu6050_set_sleep_freq(self, 1);
    mpu6050_set_int_logic_level(self, 0);

    i2c_write_bit_in_reg_inline(&self->i2c, PWR_MGMT_2, 0, 1);
    i2c_write_bit_in_reg_inline(&self->i2c, PWR_MGMT_2, 1, 1);
    i2c_write_bit_in_reg_inline(&self->i2c, PWR_MGMT_2, 2, 1);
...
void mpu6050_set_sleep_freq(struct mpu6050 *self, uint8_t state)
{
    i2c_write_bit_in_reg_inline(&self->i2c, PWR_MGMT_1, 5, 1);

    i2c_write_bit_in_reg_inline(&self->i2c, PWR_MGMT_2, 7, 1);
    i2c_write_bit_in_reg_inline(&self->i2c, PWR_MGMT_2, 6, 0);
}
...
void mpu6050_set_int_logic_level(struct mpu6050 *self, uint8_t state)
{
    i2c_write_bit_in_reg_inline(&self->i2c, INT_PIN_CFG, 7, state);
}
void mpu6050_set_int_data_ready(struct mpu6050 *self, uint8_t state)
{
    i2c_write_bit_in_reg_inline(&self->i2c, INT_ENABLE, 0, state);
}
